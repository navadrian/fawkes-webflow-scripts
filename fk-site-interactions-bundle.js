...
(function () {
  ...
  function addStyles() {
    ...
    style.textContent =
      ...
      "." + ROOT_CLASS + " .home-hero-stat-card{flex:1 1 0;min-width:0;min-height:98px;display:flex;flex-direction:column;justify-content:center;gap:5px;padding:10px;color:#fff;background:rgba(13,15,20,.42);border:1px solid rgba(255,255,255,.18);border-radius:4px;box-sizing:border-box;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);}" +
      "." + ROOT_CLASS + " .home-hero-stat-card .home-hero-stat-label{order:0;text-transform:uppercase;font-size:10px;line-height:1.15;letter-spacing:.08em;}" +
      ...
      "." + ROOT_CLASS + " .home-hero-stat-card{min-height:76px;padding:7px;}" +
