/*! fk-site-interactions — Fawkes site-header registered script — v1.1.0
 ...
 *    4. Home industries tab switcher — now crossfades the card background image
 *       + copy per tab (v1.1.0)
...
(function () {
  ...
  function init() {
    ...
    var INDUSTRY_DATA = {
      fleets: {
        chip: 'EV Fleets',
        headline: 'Protect EV fleet economics through continuous battery intelligence',
        href: '/industries/ev-fleets',
        img: CDN + '6a88772c3c2f1ca033218736_home-hero-bus.png'
      },
      financiers: {
        chip: 'EV Financiers',
        headline: 'De-risk EV lending with data-backed residual value forecasting',
        href: '/industries/ev-financiers',
        img: CDN + '6a96287b31837461f1a07309_home-carousel-financiers.jpg'
      },
      bess: {
        chip: 'BESS Owners & Operators',
        headline: 'Protect contracted revenue across full BESS system lifetime',
    ...
    if (tabRow) {
      ...
      if (visualCard && baseImg) {
        ...
        if (titleWrap) {
          ...
          titleWrap.style.transition = 'opacity .25s ease';
        }
      }
      ...
      function activate(key, pill) {
        ...
        // Copy swaps behind a short fade of the text block.
